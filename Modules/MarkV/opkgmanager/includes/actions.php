...
{	
	...
	else if($action == "install_sd")
		$cmd = "opkg install --dest sd ".$package;
...
if (isset($_POST['show_actions_popup']) && isset($_POST['package']))
{
	...
	if($installed)
		...
		echo 'Install [<a href="javascript:opkgmanager_perf_action(\''.$package.'\', \'install\');">Internal</a>] [<a href="javascript:opkgmanager_perf_action(\''.$package.'\', \'install_sd\');">SD</a>]';	
