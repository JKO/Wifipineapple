...
{
	echo '<div style=\'text-align:right\'><a href="#" id="nmap_loading" class="refresh"></a></div>';
	
	echo "nmap";
	echo "&nbsp;<font color=\"red\"><strong>&#10008;</strong></font><br /><br />";
	
	echo "Install to <a id=\"install_int\" href=\"javascript:nmap_install('internal');\">Internal Storage</a> or <a id=\"install_sd\" href=\"javascript:nmap_install('sd');\">SD Storage</a>";
	
	echo '<script type="text/javascript">notify("nmap is not installed", "nmap", "red");</script>';
