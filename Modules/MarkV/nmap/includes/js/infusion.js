...
{
	$('#nmap_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#nmap_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function nmap_load_file(which) {
    $.get('/components/infusions/nmap/includes/actions.php?load', {file: which}, function(data){
