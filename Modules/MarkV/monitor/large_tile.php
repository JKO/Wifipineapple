...
<?php
echo '<fieldset class="monitor">';
echo '<legend class="monitor">Dependencies</legend>';
if($is_vnstat_installed)
{
	echo "vnStat";
	echo "&nbsp;<span id=\"vnstat_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span><br />";
}
else
{
	echo "vnStat";
...
{
	echo "vnStati";
	echo "&nbsp;<span id=\"vnstati_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span><br />";
}
else
{
	echo "vnStati";
	echo "&nbsp;<span id=\"vnstati_status\"><font color=\"red\"><strong>&#10008;</strong></font></span><br />";
}
...
echo '<fieldset class="monitor">';
echo '<legend class="monitor">Configuration</legend>';

if($is_vnstat_installed && $is_vnstati_installed)
{
	if($is_vnstat_daemon_installed)
	{
		echo "cron <span id=\"vnstatdi_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
	...
	{
		echo "cron <span id=\"vnstatdi_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
	...
	if($is_db_sd)
	{
		...
		echo " | <a id=\"db_link\" href=\"javascript:sd_toggle('disable');\"><strong>Uninstall from SD</strong></a><br />";
	}
	else
	{
		echo "DB <span id=\"db_status\"><font color=\"red\"><strong>not persistent</strong></font></span>";
		echo " | <a id=\"db_link\" href=\"javascript:sd_toggle('enable');\"><strong>Install on SD</strong></a><br />";
	}
}
