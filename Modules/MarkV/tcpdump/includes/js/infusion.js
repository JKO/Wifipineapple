...
{
	$('#tcpdump_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#tcpdump_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function tcpdump_load_file(which) {
    $.get('/components/infusions/tcpdump/includes/actions.php?load', {file: which}, function(data){
