...
{
	echo '<div style=\'text-align:right\'><a href="#" id="tcpdump_loading" class="refresh"></a></div>';
	
	echo "tcpdump";
	echo "&nbsp;<font color=\"red\"><strong>&#10008;</strong></font><br /><br />";
	
	echo "Install to <a id=\"install_int\" href=\"javascript:tcpdump_install('internal');\">Internal Storage</a> or <a id=\"install_sd\" href=\"javascript:tcpdump_install('sd');\">SD Storage</a>";
	
	echo '<script type="text/javascript">notify("tcpdump is not installed", "tcpdump", "red");</script>';
