...
<?php
echo '<fieldset class="urlsnarf">';
echo '<legend class="urlsnarf">Dependencies</legend>';
...
echo '<fieldset class="urlsnarf">';
echo '<legend class="urlsnarf">Controls</legend>';

if ($is_urlsnarf_running) 
{
	echo "urlsnarf <span id=\"urlsnarf_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
	echo " | <a id=\"urlsnarf_link\" href=\"javascript:urlsnarf_toggle('stop');\"><strong>Stop</strong></a> ";
}
else
{ 
	echo "urlsnarf <span id=\"urlsnarf_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
...
echo '<fieldset class="urlsnarf">';
echo '<legend class="urlsnarf">Configuration</legend>';
