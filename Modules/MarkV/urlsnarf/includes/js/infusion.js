...
{
	$('#urlsnarf_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#urlsnarf_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function urlsnarf_toggle(action) {
	...
	if(action == 'stop') {
		...
		$("#urlsnarf_status").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#urlsnarf_status").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function urlsnarf_toggle_small(action) {
	...
	if(action == 'stop') {
		...
		$("#urlsnarf_small").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#urlsnarf_small").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function urlsnarf_load_file(what, which) {
    $.get('/components/infusions/urlsnarf/includes/actions.php?load', {file: which, what: what}, function(data){
