...
if (isset($_GET['load']))
{
	if (isset($_GET['file']))
	{
		if (isset($_GET['what']) && $_GET['what'] == "log")
		{
			...
			echo "<strong>urlsnarf log ".$_GET['file']." [".$log_date."]</strong><br/><br/>";
		
			echo '<textarea class="urlsnarf" cols="85" rows="29">';
		...
		if (isset($_GET['what']) && $_GET['what'] == "custom")
		{
			...
			echo "<strong>urlsnarf custom log ".$_GET['file']." [".$log_date."]</strong><br/><br/>";
