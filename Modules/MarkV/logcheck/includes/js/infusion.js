...
{
	$('#logcheck_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#logcheck_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function logcheck_toggle(action) {
	...
	if(action == 'stop') {
		...
		$("#logcheck_status").html('<font color="red"><strong>&#10008;</strong></font>');
		$("#logcheck_link").attr("href", "javascript:logcheck_toggle('start');");
	}
	else {
		$("#logcheck_link").html('<strong>Stop</strong>');
		$("#logcheck_status").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function logcheck_toggle_small(action) {
	...
	if(action == 'stop') {
		...
		$("#logcheck_status_small").html('<font color="red"><strong>&#10008;</strong></font>');
		$("#logcheck_link_small").attr("href", "javascript:logcheck_toggle_small('start');");
	}
	else {
		$("#logcheck_link_small").html('<strong>Stop</strong>');
		$("#logcheck_status_small").html('<font color="lime"><strong>&#10004;</strong></font>');
