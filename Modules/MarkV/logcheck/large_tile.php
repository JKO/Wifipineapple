...
{
	echo '<fieldset class="logcheck">';
	echo '<legend class="logcheck">Dependencies</legend>';
	...
	echo '<fieldset class="logcheck">';
	echo '<legend class="logcheck">Controls</legend>';
	
	if ($is_logcheck_running) 
	{
		echo "Logcheck <span id=\"logcheck_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
		echo " | <a id=\"logcheck_link\" href=\"javascript:logcheck_toggle('stop');\"><strong>Stop</strong></a><br />";
	}
	else 
	{ 
		echo "Logcheck <span id=\"logcheck_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
	...
	echo '<fieldset class="logcheck">';
	echo '<legend class="logcheck">Configuration</legend>';
	...
	{
		echo "cron <span id=\"cron_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
	...
	{
		echo "cron <span id=\"cron_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
