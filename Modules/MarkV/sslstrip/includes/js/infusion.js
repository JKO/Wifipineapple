...
{
	$('#sslstrip_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#sslstrip_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function sslstrip_toggle(action) {
	...
	if(action == 'stop') {
		...
		$("#sslstrip_status").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#sslstrip_status").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function sslstrip_toggle_small(action) {
	...
	if(action == 'stop') {
		...
		$("#sslstrip_small").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#sslstrip_small").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function sslstrip_load_file(what, which) {
    $.get('/components/infusions/sslstrip/includes/actions.php?load', {file: which, what: what}, function(data){
...
function sslstrip_reload() {
	draw_large_tile('sslstrip', 'infusions');
	refresh_small('sslstrip','infusions');
}
