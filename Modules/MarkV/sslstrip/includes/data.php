...
if (isset($_GET['history']))
{
	...
	for($i=0;$i<count($log_list);$i++)
	{
		...
		echo "<a href=\"/components/infusions/sslstrip/includes/actions.php?_csrfToken=".$_SESSION['_csrfToken']."&download&log&file=".basename($log_list[$i])."\">download</a> | ";
...
if (isset($_GET['custom']))
{
	...
	for($i=0;$i<count($log_list);$i++)
	{
		...
		echo "<a href=\"/components/infusions/sslstrip/includes/actions.php?_csrfToken=".$_SESSION['_csrfToken']."&download&custom&file=".basename($log_list[$i])."\">download</a> | ";
