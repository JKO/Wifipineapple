...
{
	echo '<fieldset class="sslstrip">';
	echo '<legend class="sslstrip">Dependencies</legend>';
	...
	echo '<fieldset class="sslstrip">';
	echo '<legend class="sslstrip">Controls</legend>';

	if ($is_sslstrip_running)
	{
		echo "sslstrip <span id=\"sslstrip_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
		echo " | <a id=\"sslstrip_link\" href=\"javascript:sslstrip_toggle('stop');\"><strong>Stop</strong></a> ";
		if($is_verbose)
			echo '<input class="sslstrip" type="checkbox" checked="checked" disabled="disabled" id="verbose" name="verbose" value="verbose" /> Verbose';
		else
			echo '<input class="sslstrip" type="checkbox" disabled="disabled" id="verbose" name="verbose" value="verbose" /> Verbose';
	}
	else
	{ 
		echo "sslstrip <span id=\"sslstrip_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
		echo " | <a id=\"sslstrip_link\" href=\"javascript:sslstrip_toggle('start');\"><strong>Start</strong></a> "; 
		if($is_verbose)
			echo '<input class="sslstrip" type="checkbox" checked="checked" id="verbose" name="verbose" value="verbose" /> Verbose';
		else
			echo '<input class="sslstrip" type="checkbox" id="verbose" name="verbose" value="verbose" /> Verbose';
	}
	
	echo '</fieldset><br/>';
	
	echo '<fieldset class="sslstrip">';
	echo '<legend class="sslstrip">Configuration</legend>';
