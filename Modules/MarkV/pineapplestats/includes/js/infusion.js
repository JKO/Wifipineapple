...
{
	$('#pineapplestats_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#pineapplestats_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function pineapplestats_init_small() {
...
function pineapplestats_daemon_toggle(action) {
	...
	if(action == 'stop') {
		...
		$("#daemon_status").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#daemon_status").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function pineapplestats_reload() {
	...
	refresh_small('pineapplestats','infusions');
}

function pineapplestats_refresh_tile() {
	$.ajax({
		type: "GET",
		beforeSend: pineapplestats_myajaxStart(),
		success: function(msg){
