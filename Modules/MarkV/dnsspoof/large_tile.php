...
<?php
echo '<fieldset class="dnsspoof">';
echo '<legend class="dnsspoof">Dependencies</legend>';
...
{
	echo "dnsspoof";
	echo "&nbsp;<font color=\"red\"><strong>&#10008;</strong></font><br />";
}

echo '</fieldset><br/>';

echo '<fieldset class="dnsspoof">';
echo '<legend class="dnsspoof">Controls</legend>';

if ($is_dnsspoof_running) 
{
	echo "dnsspoof <span id=\"dnsspoof_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
	echo " | <a id=\"dnsspoof_link\" href=\"javascript:dnsspoof_toggle('stop');\"><strong>Stop</strong></a><br />";
}
else
{ 
	echo "dnsspoof <span id=\"dnsspoof_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
...
echo '<fieldset class="dnsspoof">';
echo '<legend class="dnsspoof">Configuration</legend>';

if ($is_dnsspoof_onboot) 
{
	echo "Autostart <span id=\"dnsspoof_boot_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
	echo " | <a id=\"dnsspoof_boot_link\" href=\"javascript:dnsspoof_boot_toggle('disable');\"><strong>Disable</strong></a><br />";
}
else 
{ 
	echo "Autostart <span id=\"dnsspoof_boot_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
...
{
	echo "Fake captive portal files <span id=\"fake_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
	echo " | <a id=\"fake_link\" href=\"javascript:dnsspoof_fake_toggle('uninstall');\"><strong>Uninstall</strong></a><br />";
}
else
{
	echo "Fake captive portal files <span id=\"fake_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
