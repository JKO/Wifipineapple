...
{
	$('#dnsspoof_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#dnsspoof_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function dnsspoof_toggle_small(action) {
	...
	if(action == 'stop') {
		...
		$("#dnsspoof_small").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#dnsspoof_small").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function dnsspoof_load_file(which) {
    $.get('/components/infusions/dnsspoof/includes/actions.php?load', {file: which}, function(data){
...
function dnsspoof_fake_toggle(action) {
	...
	if(action == 'install'){
		...
		$('#fake_status').html('<font color="lime"><strong>&#10004;</strong></font>');
		$('#fake_link').attr("href", "javascript:dnsspoof_fake_toggle('uninstall');");
	}
	else{
		$('#fake_link').html('<strong>Install</strong>');
		$('#fake_status').html('<font color="red"><strong>&#10008;</strong></font>');
...
function dnsspoof_boot_toggle(action) {	
	...
	if(action == 'disable') {
		...
		$("#dnsspoof_boot_status").html('<font color="red"><strong>&#10008;</strong></font>');
		$("#dnsspoof_boot_link").attr("href", "javascript:dnsspoof_boot_toggle('enable');");
	}
	else {
		$("#dnsspoof_boot_link").html('<strong>Disable</strong>');
		$("#dnsspoof_boot_status").html('<font color="lime"><strong>&#10004;</strong></font>');
