...
{
	$('#wifimanager_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#wifimanager_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function wifimanager_refresh_tile() {
	$.ajax({
		...
		data: "interface",
		beforeSend: wifimanager_myajaxStart(),
		url: "/components/infusions/wifimanager/includes/interfaces_small.php",
		success: function(msg){
