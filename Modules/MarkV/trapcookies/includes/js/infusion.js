...
{
	$('#trapcookies_loading').css("background-image", "url(/includes/img/throbber.gif)");
...
{
	$('#trapcookies_loading').css("background-image", "url(/includes/img/refresh.png)");
...
function trapcookies_toggle(action) {	
	...
	if(action == 'stop') {
		...
		$("#trapcookies_status").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#trapcookies_status").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function trapcookies_toggle_small(action) {	
	...
	if(action == 'stop') {
		...
		$("#trapcookies_status_small").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#trapcookies_status_small").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function trapcookies_dnsspoof_toggle(action) {
	...
	if(action == 'stop') {
		...
		$("#dnsspoof_status").html('<font color="red"><strong>&#10008;</strong></font>');
		...
		$("#dnsspoof_status").html('<font color="lime"><strong>&#10004;</strong></font>');
...
function trapcookies_load_file(which) {
    $.get('/components/infusions/trapcookies/includes/actions.php?load', {file: which}, function(data){
...
function trapcookies_reload() {
	draw_large_tile('trapcookies', 'infusions');
	refresh_small('trapcookies','infusions');
}
