...
{
	echo '<fieldset class="trapcookies">';
	echo '<legend class="trapcookies">Dependencies</legend>';
	...
	echo '<fieldset class="trapcookies">';
	echo '<legend class="trapcookies">Controls</legend>';
	

	if ($is_ngrep_running) 
	{
		echo "trapcookies <span id=\"trapcookies_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
		echo " | <a id=\"trapcookies_link\" href=\"javascript:trapcookies_toggle('stop');\"><strong>Stop</strong></a><br />";
	}
	else
	{ 
		echo "trapcookies <span id=\"trapcookies_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
	...
	echo '<fieldset class="trapcookies">';
	echo '<legend class="trapcookies">Configuration</legend>';
	
	if($is_landing_installed)
	{
		echo "Landing Page <span id=\"landing_status\"><font color=\"lime\"><strong>&#10004;</strong></font></span>";
		echo " | <a id=\"landing_link\" href=\"javascript:trapcookies_landing_toggle('uninstall');\"><strong>Uninstall</strong></a><br />";
	}
	else
	{
		echo "Landing Page <span id=\"landing_status\"><font color=\"red\"><strong>&#10008;</strong></font></span>";
